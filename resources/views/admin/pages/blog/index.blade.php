        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('blogs.create') }}">
                + Create New Blog </a>
              ...
              <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if ($blog->image)
                      <img src="{{ asset('uploads/blogs/' . $blog->image) }}" alt="{{ $blog->title }}" width="80">
                      @else
                      No Image
                      @endif
                    </td>
                    ...
                    <td>
                      ...
                      <form hidden action="{{ route('blogs.destroy', $blog->id) }}" id="form{{ $blog->id }}"
                        method="get">
                        @csrf
                      </form>
