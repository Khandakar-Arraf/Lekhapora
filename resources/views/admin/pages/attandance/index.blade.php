                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($attandance->course) && isset($attandance->course->title))
                                            {{ $attandance->course->title }}
                                        @else
                                            <!-- Handle the case where 'course' or 'title' is null -->
                                        @endif
                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($attandance->course) && $attandance->course->title)
                                            {{ $attandance->course->title }}
                                        @else
                                            <!-- Handle the case where 'course' or 'title' is null -->
                                        @endif
                                        ...
                                        <td>
                                            ...
                                            {{ $attandance->student->name }}
                                            @else
                                            @if($attandance->teacher && $attandance->teacher->name)
    {{ $attandance->teacher->name }}
@else
    <!-- Handle the case where 'teacher' or 'name' is null -->
@endif
