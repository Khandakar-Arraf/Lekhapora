        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('categories.create') }}">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success waves-effect btn-circle waves-light"
                        href="{{ route('categories.inactive', $category->id) }}">
                        <i class="fas fa-check"></i> </a>
                      @else
                      <a class="btn btn-danger waves-effect btn-circle waves-light"
                        href="{{ route('categories.active', $category->id) }}">
                      ...
                      <form hidden action="{{ route('categories.destroy', $category->id) }}"
                        id="form{{ $category->id }}" method="get">
                        @csrf
                      </form>
                      <button class="btn btn-danger waves-effect btn-circle waves-light"
                        onclick="deleteItem({{ $category->id }});" type="button">
